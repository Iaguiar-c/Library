...
const ModalWrapper = styled.div`
  ${tw`fixed inset-0 z-50 flex items-center justify-center bg-primary-950 bg-opacity-30`}
`;

const ModalContent = styled.div`
  ${tw`relative bg-primary-100 p-8 max-w-lg rounded-lg shadow-lg`}
  
  @media (max-width: 640px) {
    ${tw`m-2`} /* Adiciona margem para telas pequenas */
  }
`;
...
const HelpModal = ({ isOpen, onClose }) => {
  ...
  const faqs = [
    { question: t("como_adicionar_um_livro"), answer: t("question1") },
    { question: t("como_marcar_um_livro_como_favorito"), answer: t("question2") },
    { question: t("como_avaliar_um_livro"), answer: t("question3") },
    { question: t("como_editar_o_meu_perfil"), answer: t("question4") },
    { question: t("como_excluir_o_meu_perfil"), answer: t("question5") },
  ];
                ...
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full py-2 px-4 bg-primary-200 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-primary-600 focus-visible:ring-opacity-75">
                      ...
                      <svg
                        className={`${open ? "transform rotate-180" : ""} w-6 h-6 text-primary-700`}
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
