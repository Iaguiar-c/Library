...
const LoginUsuario = () => {
  ...
  return (
<section className="bg-gradient-to-tl from-purple-950 to-purple-800 min-h-screen flex flex-col items-center justify-center">
  <div className="w-full max-w-6xl px-4 py-8">
    <div
      className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 m-4 shadow rounded-md"
      style={{
    ...
    >
      <div className="text-center m-4">
        <SectionDescription className="text-lg md:text-xl lg:text-2xl">
          {t("abra_a_capa_para_aventuras")}
        </SectionDescription>
        <SectionHeading className="text-3xl md:text-4xl">BOOKSTER</SectionHeading>
        <SectionHeading className="text-2xl md:text-3xl">{t("biblioteca_digital_minusculo")}</SectionHeading>
      </div>

      <div className="flex justify-center items-center md:max-w-md w-full py-4">
        <div className="w-full bg-primary-100 rounded-lg shadow dark:bg-primary-800">
          <div className="p-6 space-y-4 md:space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold leading-9 text-primary-950">
      ...
      <div className="p-6 space-y-4">
        <form className="space-y-6" onSubmit={handleVerificationSubmit}>
          ...
          <div>
            ...
            <button
              type="button"
              onClick={() => sendEmailPassword(email)}
              className="w-full mt-2 bg-primary-400 py-2 px-4 rounded-md text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-400"
            >
              {t("reenviar_email")}
            </button>
          </div>
